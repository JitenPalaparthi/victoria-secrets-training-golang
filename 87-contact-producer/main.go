...
func main() {
	...
	contacthandler := handlers.ContactHandler{IContact: contactDb, Broker: "localhost:9092", Topic: "contact-create-email"}
	contacthandler.ChMsg = make(chan []byte, 1)
	go contacthandler.Publish()
